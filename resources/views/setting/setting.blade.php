    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-xl-12 col-md-12">
            <div class="block block-rounded d-flex flex-column">
                ...
                <form method="POST" action="{{route('store.update.setting')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" value="{{optional($info)->name}}" required>
                            @error('company_name')
