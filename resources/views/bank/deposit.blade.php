...
<div class="modal fade" id="modal-block-fadein" tabindex="-1" role="dialog" aria-labelledby="modal-block-fadein" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('bank.store.deposit')}}" method="post">
                @csrf
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title text-light">Add Deposit</h3>
                ...
                <div class="block-content font-size-sm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="" required name="deposit" >
                    </div>
                    <div class="form-group">
...
<!-- END Fade In Block Modal -->
           ...
           <div class="block-options text-right">
                    <button type="button" class="btn btn-rounded btn-primary push" data-toggle="modal" data-target="#modal-block-fadein">Add Deposit</button>
                </div>
                </div>
              </div>
            </div>
